 ...
 * @author Start_a_Way
 */
public class Progress_Library extends javax.swing.JFrame implements Runnable{
    Connection conn;
    int s =0;
    Thread th;
     ...
     */
    public Progress_Library() {
        super("Progress_Library");
        initComponents();
        ...
        try {
            for(int i=0; i<=100; i++){
                ...
                if (v<k) {
                    ...
                    i=101;
                    setVisible(false);
                    Llibrary_Home h = new Llibrary_Home();
                    h.setVisible(true);
                }Thread.sleep(50);
            }            
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/book.gif"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Progress_Library.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Progress_Library().setVisible(true);
        });
    }
